\CQUsection{实验设计与结果分析}

\CQUsubsection{实验说明与可复现性}
...
\CQUsubsection{实验环境与主要依赖}
\CQUsubsubsection{硬件与软件}
...
\CQUsubsection{数据协议与预处理约定}
\CQUsubsubsection{分割任务数据}
...
\CQUsubsection{主线 A：动脉瘤分割实验设计}
\CQUsubsubsection{训练协议与超参数（与配置项对齐）}
...
\CQUsubsubsection{分割结果的多维度解读（建议在答辩中展开）}
...
\CQUsubsection{主线 B：破裂风险预测实验设计}
\CQUsubsubsection{数据划分与泄漏防护}
...
\CQUsubsection{系统集成与演示实验}
\CQUsubsubsection{Web 接口层面的任务闭环}
